    ...
    <div v-else class="shopping-cart-items">
      <ul>
        <li v-for="product in cartProducts" class="cart-product-card" tabindex="0">
          <div v-if="product.quantity>0" class="cart-product-card">
            ...
            <div>
              <button @click="reduceProductFromCart(product)" class="cart-item-remove-btn">-</button>
              <button @click="addProductToCart(product)" class="cart-item-remove-btn">+</button>
            </div>
...
@media(max-width: 600px) {
 ...
 .cart-product-card:hover .cart-item-remove-btn{
   opacity: 1;
 }
 .cart-product-card:focus .cart-item-remove-btn {
   opacity: 1;
 }
